...
.addAction({ capture: true }, async (ctx, { endFlow, flowDynamic, gotoFlow, fallBack }) => {
    ...
    console.log(opcion)
    if (!["tramites", "trámites", "cic", "género", "genero", "licencia", "licencias", "menu", "menú", "hola", "gracias", "no, gracias", "volver al menú", "Volver al menú", '001', '002', '003', '004', '005', '006', '007', '008', '009', '010'].includes(opcion)) {
        errores++;
