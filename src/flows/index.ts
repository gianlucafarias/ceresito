...
import { flowSeccionesPatio2 } from './flowSeccionesPatio2';
import { flowReciclarIA } from './flowQueReciclar';
import { flowColectividades } from './flowColectividades';
export const flow =  createFlow([flowColectividades, flowReciclarIA, flowSeccionesPatio2, flowPoda, flowInscripcionPoda, flowCongresoMujeres, flowSalud, flowCaps, flowCPC, flowCertificado, flowCargarReclamo, flowReclamos, flowPrincipal, voiceNoteFlow, mediaFlow, flowMenu, flowLlamarMenu, flowAyuda, flowLicencias, flowTramites, flowCIC, flowAdultosmayores, flowCeresito, flowDengue, flowEducacion, flowHistoria, flowResiduos, flowTurismo, flowActividadesAdultos, flowAgente, flowConsejoAdultos, flowMujerSegura, flowNumeroGuardialocal, flowSeccionesPatio, flowInactividad, flowGenero, flowPrimeraVez, flowConsultar, flowCrearReclamo])