...
export const flow =  createFlow([flowSeccionesPatio2, flowPoda, flowInscripcionPoda, flowCongresoMujeres, flowSalud, flowCaps, flowCPC, flowCertificado, flowCargarReclamo, flowReclamos, flowPrincipal, voiceNoteFlow, mediaFlow, flowMenu, flowLlamarMenu, flowAyuda, flowLicencias, flowTramites, flowCIC, flowAdultosmayores, flowCeresito, flowDengue, flowEducacion, flowHistoria, flowResiduos, flowTurismo, flowActividadesAdultos, flowAgente, flowConsejoAdultos, flowMujerSegura, flowNumeroGuardialocal, flowSeccionesPatio, flowInactividad, flowGenero, flowPrimeraVez, flowConsultar, flowCrearReclamo])